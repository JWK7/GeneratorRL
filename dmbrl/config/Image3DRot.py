...
class Image3DRotConfigModule:
    ...
    def _create_exp_cfg(self):
        ...
        self.exp_cfg.iteration = 50
        self.exp_cfg.alpha = 0.0001
        self.exp_cfg.beta = 0.0001
        self.exp_cfg.data_size = 5
        self.exp_cfg.num_generators = 3
        self.exp_cfg.image_dim = (10*10*10,)
        self.exp_cfg.generator_dim = (10*10*10,10*10*10)
        self.exp_cfg.T = 30
    ...
    def sample(self):
        I0 = DataFunctions.NoiseImage(((self.exp_cfg.data_size,)+(10,10,10)))
        x,Ix = DataFunctions.Rotate3D(I0,self.exp_cfg.T)
        I0= I0.reshape((self.exp_cfg.data_size,)+(10*10*10,1))
        Ix = Ix.reshape((self.exp_cfg.data_size,)+(10*10*10,1))
